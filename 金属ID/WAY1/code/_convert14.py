...
TXT_DIR = Path(r'D:\aaa_my_iwhalecloud\VScode_AI\HunyuanOCR\津巴布韦API开发测试\WAY1\txt\金属ID-PROMPT14-OUT')
OUTPUT_XLSX = Path(r'D:\aaa_my_iwhalecloud\VScode_AI\HunyuanOCR\津巴布韦API开发测试\WAY1\xlsx\PROMPT14_ocr_result-jin.xlsx')
...
for row_idx, txt_path in enumerate(txt_files, 2):
    ...
    try:
        ...
        # PROMPT14 already outputs clean JSON (post-processed)
        data = json.loads(raw)
