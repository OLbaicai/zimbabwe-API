...
# 识别结果输出目录（不存在会自动创建）
OUTPUT_DIR = Path(r"D:\aaa_my_iwhalecloud\VScode_AI\HunyuanOCR\津巴布韦API开发测试\津巴布韦-彩色驾照\txt\MAIN-TEST-ORIGIN-OUT")

# -------------------- 单张测试模式 --------------------
# 若需单独测试某张图片，请将文件名（含扩展名）填入下方字符串，例如："04045144V04.jpg"
# 若无需单张测试，请保持为空字符串：TEST_SINGLE_FILE = ""
TEST_SINGLE_FILE = "WhatsApp Image 2026-04-13 at 10.49.36.jpeg"   # 填入要测试的图片文件名，留空则正常批量处理
# -----------------------------------------------------
